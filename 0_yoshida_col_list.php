...
<meta property="og:url" content="https://kobewhiteningnavi.com/col.html" />
<meta property="og:type" content="website" />
<meta property="og:title" content="コラム一覧" />
<meta property="og:description" content="KOBEホワイトニングのコラム一覧です。" />
...
<div class="box">
			...
			<div class="box-center-t text-center">
				<h3 class="mt-3 white text-shadow">コラム一覧</h3>
...
<div>
		<section class="container text-center mt-5">
			...
			<div class="row">
<?php
$sql="select*from post where cate like '%002%' order by date DESC";
$stmt=$dbh->query($sql);
...
?>
				<div class="col-md-3">
					<div class="card mt-5">
					<a href="./col_post_<?=$row['code']?>.html"><img src="./eyecatch/<?=$row['code']?>_thumb.jpg" class="card-img-top" alt="..." width="80%"></a>

						<h4 class="card-title m-0"><?=$row['title']?></h4>

						<h8 class="card-text"><?=$article?></h8>
						<div class="card-body">
							<a href="./col_post_<?=$row['code']?>.html" class="btn btn-color mb-5">もっと見る</a>
						</div>
					</div>
				</div>
<?php endforeach;?>
