<div class="col-sm-3">
<a href="col_list.html" class="btn btn-sm btn-block bg-navy text-white mb-3">コラム一覧</a>


<?php
$sql = "select * from post where code!='$_GET[code]' and cate like '%002%' order by date DESC limit 5";
$stmt=$dbh->query($sql);
...
<div class="mb-2">
<a href="col_post_<?=$row['code']?>.html"><img src="<?=$img?>" class="img-fluid"></a>
</div>
<div class="mb-2"><a href="col_post_<?=$row['code']?>.html" style="color:#3B4D7C;"><?=$row['title']?></a></div>
</div>
